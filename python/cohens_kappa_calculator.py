...
if __name__ == '__main__':
    ...
    own_file_name = 'own_coding_hot_one_encoding.csv'
    double_coder_file_name = 'mahiras_coding_hot_one_encoding.csv'
    ...
    csv2 = []
    with open('mahiras_coding_hot_one_encoding.csv', 'r') as file2:
